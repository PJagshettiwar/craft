...
tasks → implement → review → archive using [OpenSpec](https://github.com/Fission-AI/OpenSpec), with [Superpowers](https://github.com/obra/superpowers) discipline built in.
...
| `/craft-pr` | Create a PR from the project template + collect a Claude Code experience survey (optionally posts to Jira). |
...
└── PROJECT.md         Generated by /craft-init — not in repo (gitignored)
```
